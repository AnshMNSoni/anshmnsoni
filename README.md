...
<img src="https://skillicons.dev/icons?i=python,fastapi,flask,mysql,postgres,firebase,dart,flutter,git,github,docker,java,cpp,c,arduino,vite,html,css,tailwindcss,bootstrap,linux,ubuntu,windows,vscode,anaconda,powershell,pycharm,bash,notion" />
